...
import com.testapp.mostpopularnews.databinding.FragmentItemListBinding
import com.testapp.mostpopularnews.databinding.LayoutSortBinding
...
import com.testapp.mostpopularnews.ui.detail.ItemDetailFragmentDirections
...
//                showPopupMenu(menuItemView)
    ...
    {
        var wrapper: Context =  ContextThemeWrapper(requireActivity(), R.style.CustomPopUpStyle)
        ...
        popupMenu.setOnMenuItemClickListener { menuItem -> // Toast message on menu item clicked
            Toast.makeText(activity, "You Clicked " + menuItem.title, LENGTH_SHORT)
                .show()
            true
        }
